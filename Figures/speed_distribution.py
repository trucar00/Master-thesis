...
for gear_folder, gear_label in GEARS.items():
    dfs = []

    for month in MONTHS:
        path = Path(f"gear/{gear_folder}/{month:02d}.parquet")
...
plt.savefig("speed_distribution_stat.pdf", bbox_inches="tight", pad_inches=0.05)
plt.show()
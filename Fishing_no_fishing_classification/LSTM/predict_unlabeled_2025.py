...
ALL_VESSELS_2025_FILES = [
    f"{FEATURESETS_PATH}/all_vessels_unlabeled_2025_1_2.parquet",
    f"{FEATURESETS_PATH}/all_vessels_unlabeled_2025_3_4.parquet",
    f"{FEATURESETS_PATH}/all_vessels_unlabeled_2025_5_6.parquet",
    f"{FEATURESETS_PATH}/all_vessels_unlabeled_2025_7_8.parquet",
    f"{FEATURESETS_PATH}/all_vessels_unlabeled_2025_9_10.parquet",
    f"{FEATURESETS_PATH}/all_vessels_unlabeled_2025_11_12.parquet",
]
...
for f in ALL_VESSELS_2025_FILES:
    ...
    df_predict.to_parquet(f"{PREDICTIONS_PATH}/2025_all_vessels_monthpair-{save_id}.parquet", index=False)
    save_id += 1
